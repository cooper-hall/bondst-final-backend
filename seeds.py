...
# Add your seed data
    with app.app_context():
      ...
      bottle2 = Bottle("Ki No Bi", '24', '8.50', 'Gin', 10)
      bottle3 = Bottle("Monkey 47", '24', '10.50', 'Gin', 10)
      bottle4 = Bottle("Jack Daniels", '24', '5.50', 'Whiskey', 10)
      bottle5 = Bottle("Nikka Coffey Whiskey", '24', '8.50', 'Whiskey', 10)
      bottle6 = Bottle("Hibiki", '24', '10.50', 'Whiskey', 10)
      bottle7 = Bottle("Tito's Vodka", '24', '5.50', 'Vodka', 10)
      bottle8 = Bottle("Reyka", '24', '8.50', 'Vodka', 10)
      bottle9 = Bottle("Kastra Elion", '24', '10.50', 'Vodka', 10)
      employee1 = Employee("bradchad", "1111")
      employee2 = Employee("debra26", "2222")
      employee3 = Employee("brian43", "3333")

      db.session.add_all(
          [drink1, drink2, drink3, drink4, drink5, drink6, drink7, drink8, drink9, bottle1, bottle2, bottle3, bottle4, bottle5, bottle6, bottle7, bottle8, bottle9, employee1, employee2, employee3])
      db.session.commit()
